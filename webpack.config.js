...
const circleChords = require('./pages/circle-chords/data');
...
module.exports = {
  ...
  entry: {
    index: './pages/circle-chords/index.js',
  },
  output: {
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin({
      title: `${circleChords.title} | Music Experiments`,
      filename: 'circle-chords.html',
      template: 'pages/circle-chords/index.ejs',
      templateParameters: {
        footer: renderFooter(author.url),
